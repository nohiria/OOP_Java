...
public class POOej11 {
    ...
    public static void main(String[] args) {
        ...
        while(year<1900||year>fechaActual.getYear()+1900){
        ...
        Date fecha1= new Date(year-1900, month, day);
        System.out.println(fecha1);
        
        int yearsBetween= Math.abs(fecha1.getYear()-fechaActual.getYear());
        
        System.out.println("Entre la fecha de y la fecha actual hay "+yearsBetween+" años de diferencia");
    }
